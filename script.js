// URLs das planilhas
const PLANILHA_ESTABELECIMENTO = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSMTI1oRuII69_HW_5ddCcFCShzqq35djC2SZCKHQtjcXjI2AqXUYegWhmmhqAuHl-k7mt1Yt5xXisE/pub?gid=0&single=true&output=csv';
const PLANILHA_CATEGORIAS = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSMTI1oRuII69_HW_5ddCcFCShzqq35djC2SZCKHQtjcXjI2AqXUYegWhmmhqAuHl-k7mt1Yt5xXisE/pub?gid=671476325&single=true&output=csv';
const PLANILHA_ITENS = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSMTI1oRuII69_HW_5ddCcFCShzqq35djC2SZCKHQtjcXjI2AqXUYegWhmmhqAuHl-k7mt1Yt5xXisE/pub?gid=1786077724&single=true&output=csv';
...
function desabilitarBotoesAdicionar() {
    ...
    botoes.forEach(botao => {
        if (!botao.disabled) {
            botao.disabled = true;
            botao.classList.remove('bg-cyan-500', 'hover:bg-cyan-600');
...
function habilitarBotoesAdicionar() {
    ...
    botoes.forEach(botao => {
        ...
        if (item && (item.disponivel === 'TRUE' || item.disponivel === true || item.disponivel === 'true')) {
            ...
            botao.classList.add('bg-cyan-500', 'text-white', 'hover:bg-cyan-600');
